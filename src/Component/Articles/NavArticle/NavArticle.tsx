    ...
    return (
        ...
        <div className={styles.container}>
            <ul className={styles.wrapperLinks}>
                ...
                <Link href="/" className={`${pathname === '/articles' ? styles.active_link : styles.link}`}>All</Link>
                <Link href="#" className={`${pathname === '/articles/bass' ? styles.active_link : styles.link}`}>Bass</Link>
