...
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}   src={imageAcoustic} />)
//         }
//         if (element.category === 'bass') {
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}  src={imageBass} />)
//         } if (element.category === 'classic') {
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}  src={imageClassic} />)
//         } if (element.category === 'electric') {
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}  src={imageElectric} />)
//         } if (element.category === 'electroAcoustic') {
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}  src={imageElectroAcoustic} />)
//         } if (element.category === 'ukulele') {
//           return (<CardItem price={element.price} title={element.name} id={element.id}  data={element}  src={imageUkulele} />)
//         }
//       })}
//     </>
//   )
